...
\subsubsection{有机物的燃烧通式}
    ...
    \end{center}
    即对于$1$mol~\ce{C_xH_{4y}}的燃烧，消耗x$+$y~mol的\ce{O2}，产生x~mol的\ce{CO2}，产生2y~mol的\ce{H2O}。\\[8mm]
...
\subsubsection{有机物中碳原子的级}
    ...
    例如在下面这个例子中，分别用红橙黄绿表示了一二三四级碳原子：\vspace{5pt}
    \begin{figure}[h]
        \begin{center}
            \setchemfig{atom sep=15pt}
            \setchemfig{fixed length=true}
            \chemfig
            {
                {\color{red} C}H_3-{\color{orange} C}H_2-{\color{green} C}(-[2]CH_3)(-[6]CH_3)-\chemskipalign{\textcolor[rgb]{0.95,0.95,0.2}{C}}H(-[2]CH_3)-CH_3
            }
            \caption{碳原子的级（红=伯碳~~橙=叔碳~~黄=叔碳~~绿=季碳）}
        \end{center}
    \end{figure}\\
    连接与伯碳的氢原子称为伯氢，连接与仲碳的氢原子称为仲氢，连接与叔碳的氢原子称为叔氢。\\
