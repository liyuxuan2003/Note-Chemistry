...
\subsubsection{卤素和水的反应}
    氟和水可以剧烈反应，生成氢氟酸和氧气：
    \begin{center}
        \ce{2F2 + 2H2O -> 4HF + O2}\\[5mm]
    \end{center}
    氯和水可以进行反应，生成氢氯酸和次氯酸：
    \begin{center}
        \ce{Cl2 + H2O <=> HCl + HClO}\\[5mm]
    \end{center}
    溴和水反应较为缓慢，生成氢溴酸和次溴酸：
    \begin{center}
        \ce{Br2 + H2O <=> HBr + HBrO}\\[5mm]
    \end{center}
    碘和水反应非常缓慢，生成氢碘酸和次碘酸：
    \begin{center}
        \ce{I2 + H2O <=> HI + HIO}\\[5mm]
    \end{center}
    ...
    \begin{center}
        \ce{2HClO -> 2HCl + O2 ^}\\[5mm]
    \end{center}
    次溴酸不稳定，会自发的分解为氢溴酸和氧气：
    \begin{center}
        \ce{2HBrO -> 2HBr + O2 ^}\\[5mm]
    \end{center}
...
\subsubsection{三氧化硫和水的的反应}
    ...
    硫酸是二元强酸，具有酸的通性：
    \begin{center}
        \ce{H2SO4 + 2NaOH -> Na2SO4 + 2H2O}\\[4mm]
    \end{center}
...
\subsection{过氧化氢}
    ...
    过氧化氢（\ce{H2O2}）可以和水（\ce{H2O}）任意比例互溶。

\subsubsection{过氧化氢的不稳定性}
    过氧化氢在通常的情况下，会缓慢分解：
    \begin{center}
        \ce{2H2O2 -> 2H2O + O2 ^}\\[4mm]
    \end{center}
    过氧化氢在催化剂催化下，会快速分解：
    \begin{center}
        \ce{2H2O2 ->T[\ce{MnO2}] 2H2O + O2 ^}\\[4mm]
    \end{center}
...
\subsubsection{过氧化氢的氧化性}
    ...
    过氧化氢可以将氯化亚铁氧化为氯化铁：
    \begin{center}
        \ce{2FeCl2 + 2HCl + H2O2 -> 2FeCl3 + 2H2O}\\[4mm]
    \end{center}
    过氧化氢也可以将硫化铅氧化为硫酸铅：
    \begin{center}
        \ce{Pbs + 2H2O2 -> PbSO4 + 4H2O}
    \end{center}
...
\subsubsection{铵盐受热分解}
    ...
    碳酸铵常温就会分解，产生氨气和二氧化碳：
    \begin{center}
        \ce{(NH4)2CO3 ->T[常温] 2NH3 ^ + CO2 ^ + H2O}\\[4mm]
    \end{center}
    碳酸氢铵受热时分解，产生氨气和二氧化碳：
    \begin{center}
...
\subsubsection{硝酸和金属的反应}
    ...
    稀硝酸可以在常温条件下和铁和铝反应：
    \begin{center}
        \ce{3Fe + 8HNO3\text{(稀)} -> 3Fe(NO3)2 + 2NO ^ + 4H2O}\\[3mm]
        \ce{2Fe + 8HNO3\text{(稀)} -> 2Fe(NO3)3 + 2NO ^ + 4H2O}\\[3mm]
        \ce{2Al + 8HNO3\text{(稀)} -> 2Al(NO3)3 + 2NO ^ + 4H2O}\\[6mm]
    \end{center}
    浓硝酸需要在加热条件下和铁和铝反应：
    \begin{center}
        \ce{Fe + 6HNO3\text{(浓)} ->T[加热] Fe(NO3)3 + 3NO2 ^ + 3H2O}\\[3mm]
        \ce{Al + 6HNO3\text{(浓)} ->T[加热] Al(NO3)3 + 3NO2 ^ + 3H2O}\\[6mm]
    \end{center}
...
\subsubsection{硝酸盐}
    硝酸为一元酸，只能形成硝酸盐\ce{NO3-}。\\[3mm]
    硝酸盐全部都是易溶于水的晶体，受热时容易分解。\\[3mm]
    硝酸钾受热分解，产生氧气和亚硝酸钾：
    \begin{center}
        \ce{2KNO3 ->T[加热] 2KNO2 + O2 ^}\\[6mm]
    \end{center}
...
\subsubsection{磷和氢氧化钾的反应}
    ...
    \begin{center}
        \ce{4P + 3KOH + 3H2O ->T[加热] PH3 ^ + 3KH2PO2}\\[7mm]
    \end{center}
    磷化氢是一种无色剧毒气体。
...
\subsubsection{磷和氧气的反应}
    ...
    \begin{center}
        \ce{4P + 3O2 ->T[点燃] 2P2O3}\\[7mm]
    \end{center}
    磷可以和氧气在点燃的条件下反应，氧气充足时生成五氧化二磷：
    \begin{center}
        \ce{4P + 5O2 ->T[点燃] 2P2O5}\\[7mm]
    \end{center}
...
\subsubsection{钾肥}
    ...
    钾肥主要包括了：草木灰，硫酸钾，氯化钾，其肥效以\ce{K2O}\%表示。\\[3mm]
    钾肥中的草木灰的有效成分是碳酸钾，由于其呈碱性因此不宜与铵态氮肥混用。

\subsubsection{磷肥}
    磷元素促进植物的根系发达，增强吸收养分的能力，增强抗寒抗旱的能力。\\[3mm]
    磷肥主要包括了：普钙，重钙，钢渣氮肥，脱磷氮肥，其肥效以\ce{P2O5}\%表示。\\[3mm]
    普钙由磷酸钙和硫酸反应得到：
    \begin{center}
        \ce{Ca3(PO4)2 + 2H2SO4 -> 2CaSO4 + Ca(H2PO4)2}\\[4mm]
    \end{center}
    重钙由磷酸钙和磷酸反应得到：
    \begin{center}
        \ce{Ca3(PO4)2 + 4H3PO4 -> 3Ca(H2PO4)2}\\[4mm]
    \end{center}
...
\subsubsection{氮肥}
    ...
    氮肥主要包括了：尿素，碳铵，硫铵，硝铵，氨水，其肥效以\ce{N}\%表示。\\[3mm]
    氮肥的特点如下：\vspace{3pt}
    \begin{table}[h]
        \begin{center}
...
\subsubsection{钠和非金属的反应}
    ...
    \begin{center}
        \ce{2Na + O2 ->T[点燃] Na2O2}\\[6mm]
    \end{center}
    钠可以在空气中燃烧，生成白色固体氧化纳：
    \begin{center}
        \ce{4Na + O2 ->T[点燃] 2Na2O}\\[6mm]
    \end{center}
    钠可以在氯气中燃烧，生成白色固体氯化钠：
    \begin{center}
        \ce{2Na + Cl2 ->T[点燃] 2NaCl}\\[6mm]
    ...
    \begin{center}
        \ce{2Na + S ->T[加热] Na2S}\\[6mm]
    \end{center}
    钠可以和氢气在加热时反应，生成灰色固体氢化钠：
    \begin{center}
        \ce{2Na + H2 ->T[加热] 2NaH}\\[6mm]
    \end{center}
...
\subsubsection{氢氧化钠和钠的工业制法}
    电解饱和食盐水可以得到氢氧化钠：
    \begin{center}
        \ce{2NaCl + 2H2O ->T[通电] 2Na + H2 ^ + Cl2 ^}\\[6mm]
    \end{center}
    电解熔融氯化钠则可以得到金属钠：
    \begin{center}
        \ce{2NaCl ->T[通电] 2Na + Cl2 ^}\\[6mm]
    \end{center}
...
\subsection{碳酸钠}
    ...
    碳酸氢钠和氢氧化钠反应可以生成碳酸钠：
    \begin{center}
        \ce{NaHCO3 + NaOH -> Na2CO3 + H2O}\\[6mm]
    \end{center}
    碳酸氢钠和盐酸的反应较为剧烈，产生二氧化碳：
    \begin{center}
        \ce{NaHCO3 + HCl -> NaCl + CO2 ^ + H2O}\\[6mm]
    \end{center}
    碳酸钠和盐酸的反应则较为平和，产生二氧化碳：
    \begin{center}
        \ce{Na2CO3 + 2HCl -> 2NaCl + CO2 ^ + H2O}\\[6mm]
    \end{center}
    碳酸氢钠在加热时分解，产生二氧化碳：
    \begin{center}
        \ce{2NaHCO3 ->T[加热] Na2CO3 + CO2 ^ + H2O}\\[6mm]
    \end{center}
    碳酸钠在加热时则不发生分解，据此可以鉴别碳酸钠和碳酸氢钠。\\[3mm]
    碳酸钠通常含结晶水形成十水合碳酸钠（\ce{Na2CO3 * 10H2O}），在干燥的空气中失去结晶水风化。
...
\subsection{锂}
    ...
    锂在空气中燃烧，产生较多的氧化锂：
    \begin{center}
        \ce{4Li + O2 ->T[点燃] 2Li2O}\\[6mm]
    \end{center}
    锂在空气中燃烧，产生较少的氮化锂：
    \begin{center}
        \ce{6Li + N2 ->T[点燃] 2Li3N}\\[6mm]
    \end{center}
    锂可以和水反应，产生氢氧化锂和氢气：
    \begin{center}
        \ce{2Li + 2H2O -> 2LiOH + H2 ^}\\[6mm]
    \end{center}
...
\subsection{钾}
    ...
    钾在空气中燃烧，主要产生超氧化钾：
    \begin{center}
        \ce{K + O2 ->T[点燃] KO2}\\[6mm]
    \end{center}
    钾可以和水反应，产生氢氧化钾和氢气：
    \begin{center}
        \ce{2K + 2H2O -> 2KOH + H2 ^}\\[6mm]
    \end{center}
...
\subsection{碱金属}
    碱金属包含五种元素：锂（\ce{Li}），钠（\ce{Na}），钾（\ce{K}），铷（\ce{Rb}），铯（\ce{Cs}）。\\[3mm]
