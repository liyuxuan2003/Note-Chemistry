...
\subsubsection{硝酸和金属的反应}
    ...
    稀硝酸可以在常温条件下和铁和铝反应：
    \begin{center}
        \ce{3Fe + 8HNO3 -> 3Fe(NO3)2 + 2NO ^ + 4H2O}\\[3mm]
        \ce{2Fe + 8HNO3 -> 2Fe(NO3)3 + 2NO ^ + 4H2O}\\[3mm]
        \ce{2Al + 8HNO3 -> 2Al(NO3)3 + 2NO ^ + 4H2O}\\[6mm]
    \end{center}
    稀硝酸可以在常温条件下和铁和铝反应：
    \begin{center}
        \ce{Fe + 6HNO3 -> Fe(NO3)3 + 3NO2 ^ + 3H2O}\\[3mm]
        \ce{Al + 6HNO3 -> Al(NO3)3 + 3NO2 ^ + 3H2O}\\[6mm]
    \end{center}
