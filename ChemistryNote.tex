...
\newpage
    ...
    \begin{center}
        \ce{H2$\LiValence{+}{6}{S}$O4\text{(浓)} + 2HBr ->T[加热] $\LiValence{+}{4}{S}$O2 ^ + Br2 + 2H2O}\\[3mm]
        \ce{H2$\LiValence{+}{6}{S}$O4\text{(浓)} + 8HI ->T[加热] H2$\LiValence{-}{2}{S}$ ^ + 4I2 + 4H2O}\\[3mm]
    \end{center}
...
\subsection{氯气}
    ...
    氯气可以溶于水，常温下$1$体积的水可以溶解$2$体积的氯气。
...
\subsection{氯化氢}
    ...
    氯化氢可以溶于水，常温下$1$体积的水可以溶解$500$体积的氯化氢。\\[3mm]
    氯化氢溶于水的产物称为盐酸。
...
\subsubsection{卤素和水的反应}
    ...
    氢氯酸，氢溴酸，氢碘酸，三者均为强酸，具有一定还原性。\\[3mm]
...
\subsection{硫化氢}
    ...
    硫化氢可以溶于水，常温下$1$体积的水可溶解$2.6$体积的硫化氢。\\[3mm]
    硫化氢溶于水的产物称为氢硫酸。
...
\subsection{二氧化硫}
    ...
    二氧化硫可以溶于水，常温下$1$体积的水可以溶解$40$体积的二氧化硫。

\subsubsection{二氧化硫的还原性}
    二氧化硫的还原性较强。\\[3mm]
    二氧化硫可以被氧气氧化，产生三氧化硫：
    \begin{center}
        \ce{2SO2 + O2 <=>T[催化剂][加热] 2SO3}\\[6mm]
    \end{center}
...
\subsubsection{浓硫酸的吸水性}
    ...
    \begin{center}
        \ce{H2SO4\text{(浓)} + 2HBr ->T[加热] SO2 ^ + Br2 + 2H2O}\\[3mm]
        \ce{H2SO4\text{(浓)} + 2HI ->T[加热] SO2 ^ + I2 + 2H2O}
    \end{center}
...
\subsubsection{浓硫酸和非金属的反应}
    ...
    浓硫酸和过量溴化氢反应，产生二氧化硫：
    \begin{center}
        \ce{2HBr + H2SO4\text{(浓)} -> Br2 + SO2 ^ + 2H2O}\\[6mm]
    \end{center}
    浓硫酸和少量碘化氢反应，产生二氧化硫：
    \begin{center}
        \ce{2HI + H2SO4\text{(浓)} -> I2 + SO2 ^ + 2H2O}\\[6mm]
    \end{center}
    浓硫酸和过量碘化氢反应，产生硫化氢：
    \begin{center}
        \ce{8HI + H2SO4\text{(浓)} -> 4I2 + H2S ^ + 4H2O}\\[6mm]
    \end{center}
    浓硫酸和少量硫化氢反应，只产生二氧化硫，不产生硫：
    \begin{center}
        \ce{H2S + 3H2SO4\text{(浓)} -> 4SO2 ^ + 4H2O}\\[6mm]
    \end{center}
    浓硫酸和适量硫化氢反应，既产生二氧化硫，又产生硫：
    \begin{center}
        \ce{H2S + H2SO4\text{(浓)} -> SO2 ^ + S v + 2H2O}\\[6mm]
    \end{center}
    浓硫酸和过量硫化氢反应，不产生二氧化硫，只产生硫：
    \begin{center}
        \ce{3H2S + H2SO4\text{(浓)} -> 4S v + 4H2O}\\[6mm]
    \end{center}
