...
\subsection{有机物}
    ...
    由于一些历史原因，碳酸盐，碳氧化物，氰化物，这些物质虽然含碳但仍然被归入无机物。\\
...
\subsubsection{有机物的突破}
    ...
    \begin{center}
        ...
        \schemestart
            \chemname[15pt]{\chemfig{NH_4CNO}}{氰酸铵}
            ~~~~\arrow(foo.mid east--bar.mid west){->[\footnotesize 加热]}~~~~
            \chemname[15pt]{\chemfig{C(-[0]NH_2)(-[4]NH_2)(=[2]O)}}{尿素}
        \schemestop
    \end{center}\vspace{10pt}
    维勒的实验第一次通过人工方法，由无机物制取有机物。\\[3mm]
    维勒的实验强烈的震撼了生命力说，突破了无机物和有机物的鸿沟。\\
...
% \subsection{甲烷}
%     甲烷的分子式是\ce{CH4}，其结构式为：\vspace{3pt}
%     \begin{center}
...
%             \+{12pt,10pt,1pt}
%             \ce{Cl2}
%             ~~~~\arrow(foo.mid east--bar.mid west){->[光照]}~~~~
%             \chemname[15pt]{\chemfig{C(-[0]Cl)(-[2]H)(-[4]H)(-[6]H)}}{一氯甲烷}
%             \+{12pt,10pt,1pt}
%             \ce{HCl}
%         \schemestop
...
%         \ce{Cl2}
%         ~~~~\arrow(foo.mid east--bar.mid west){->[光照]}~~~~
%         \chemname[15pt]{\chemfig{C(-[0]Cl)(-[2]H)(-[4]H)(-[6]Cl)}}{二氯甲烷}
%         \+{12pt,10pt,1pt}
%         \ce{HCl}
%         \schemestop
...
%         \ce{Cl2}
%         ~~~~\arrow(foo.mid east--bar.mid west){->[光照]}~~~~
%         \chemname[15pt]{\chemfig{C(-[0]Cl)(-[2]Cl)(-[4]H)(-[6]Cl)}}{三氯甲烷}
%         \+{12pt,10pt,1pt}
%         \ce{HCl}
%         \schemestop
...
%         \ce{Cl2}
%         ~~~~\arrow(foo.mid east--bar.mid west){->[光照]}~~~~
%         \chemname[15pt]{\chemfig{C(-[0]Cl)(-[2]Cl)(-[4]Cl)(-[6]Cl)}}{四氯甲烷}
%         \+{12pt,10pt,1pt}
%         \ce{HCl}
%         \schemestop
%     \end{center}
...
%     \end{center}
%     甲烷在空气中燃烧时，其火焰颜色为淡蓝色。\\[10mm]
%     甲烷的实验室制法：
%     \begin{center}
%         \ce{CH3COONa + NaOH ->T[\ce{CaO}][加热] Na2CO3 + CH4 ^}\\[3mm]
%     \end{center}
%     无水醋酸钠和碱石灰混合加热可以制取\ce{CH4}气体。\\

% \subsection{烷烃}
%     烷烃指的是碳原子间均以碳碳单键结合的链状碳氢化合物称为。\\[3mm]
%     烷烃的化学通式为\ce{C_{n}H_{2n+2}}。\\[5mm]
%     以下列出了部分烷烃的结构式：\vspace{10pt}
%     \begin{center}
%         \setchemfig{atom sep=25pt}
%         \chemname[15pt]
%         {
