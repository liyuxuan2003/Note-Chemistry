...
\subsubsection{氮的氧化物}
    ...
    二氧化氮可以被氢氧化钠吸收：
    \begin{center}
        \ce{2NO2 + 2NaOH -> NaNO3 + NaNO2 + H2O}\\[4mm]
    \end{center}
    三氧化二氮和水反应，产生亚硝酸：
    \begin{center}
...
\subsubsection{有机物的燃烧通式}
    ...
    \begin{center}
        \ce{C_xH_{4y} + $(x+y)~$O2 ->  $x$CO2 + $2y~$H2O}\\[3mm]
    \end{center}
    即对于$1$mol~\ce{C_xH_{4y}}的燃烧，消耗x$+$y~mol的\ce{O2}，产生x~mol的\ce{CO2}，产生2y~mol的\ce{H2O}。\\[10mm]
    由碳氢氧三种元素组成的有机物有以下燃烧通式：
    \begin{center}
        \ce{C_xH_{4y}O_{2z} + $(x+y-z)~$O2 ->  $x$CO2 + $2y~$H2O}\\[3mm]
    \end{center}
    即对于$1$mol~\ce{C_xH_{4y}O_{2z}}的燃烧，消耗x$+$y$-$z~mol的\ce{O2}，产生x~mol的\ce{CO2}，产生2y~mol的\ce{H2O}。\\
...
\subsubsection{有机物中碳原子的级}
    ...
    \begin{figure}[h]
        \begin{center}
            ...
            \chemfig
            {
                {\color{red} C}H_3-{\color{orange} C}H_2-{\color{blue} C}(-[2]CH_3)(-[6]CH_3)-\chemskipalign{{\color{green} C}}H(-[2]CH_3)-CH_3
            }
...
\subsubsection{有机物中氢原子的级}
    ...
    \begin{figure}[h]
        \begin{center}
            ...
            \chemfig
            {
                C{\color{red} H_3}-C{\color{orange} H_2}-C(-[2]CH_3)(-[6]CH_3)-\chemskipalign{C}|{\color{green} H}(-[2]CH_3)-CH_3
            }
...
\subsubsection{甲烷}
    ...
    \end{center}
    甲烷可以和氯气发生取代反应，第二步生成二氯甲烷：\vspace{15pt}
    \begin{center}
        \chemnameinit{\chemfig{C(-[0]H)(-[2]H)(-[4]H)(-[6]H)}}
        \setchemfig{atom sep=15pt}
        \setchemfig{fixed length=true}
...
\newpage
    ...
    甲烷可以和氯气发生取代反应，第三步生成三氯甲烷：\vspace{15pt}
    \begin{center}
        \chemnameinit{\chemfig{C(-[0]H)(-[2]H)(-[4]H)(-[6]H)}}
        \setchemfig{atom sep=15pt}
        \setchemfig{fixed length=true}
        ...
        \schemestop\vspace{15pt}
    \end{center}
    甲烷可以和氯气发生取代反应，第四步生成四氯甲烷：\vspace{15pt}
    \begin{center}
        \chemnameinit{\chemfig{C(-[0]H)(-[2]H)(-[4]H)(-[6]H)}}
        \setchemfig{atom sep=15pt}
        \setchemfig{fixed length=true}
        ...
        \schemestop\vspace{15pt}
    \end{center}
    该实验中会观察到黄绿色气体变为无色，产生油状液体，产生白雾。\\[5mm]
    该实验中生成的取代产物中：\\[3mm]
    一氯甲烷为无色气体，密度为$2.22\text{kg}/\text{m}^3$，重于空气。\\[3mm]
    二氯甲烷为无色油状液体，密度为$1.33\text{g}/\text{cm}^3$，重于水。\\[3mm]
    三氯甲烷为无色油状液体，密度为$1.48\text{g}/\text{cm}^3$，重于水。\\[3mm]
    四氯甲烷为无色油状液体，密度为$1.58\text{g}/\text{cm}^3$，重于水。\\[3mm]

\newpage

\subsubsection{烷烃}
    烷烃指的是一类碳原子间均为碳碳单键的链状碳氢化合物。\\[3mm]
    烷烃的分子式可以使用通式~\ce{C_{n}H_{2n+2}}表示。\\[5mm]
    ...
    \end{center}\vspace{15pt}
    对于更为复杂的烷烃，使用简单的正异新的前缀已经无法区分，需要使用系统命名法进行命名。
...
\subsubsection{环烷烃}
    ...
    环烷烃的分子式可以使用通式~\ce{C_{n}H_{2n}}表示。\\[5mm]
...
\subsubsection{乙烯}
    ...
    乙烯可以在空气中燃烧，火焰明亮伴有黑烟：
    \begin{center}
        \ce{C2H4 + 3O2 ->T[点燃] 2CO2 + 2H2O}\\[3mm]
    \end{center}
    乙烯可以通过无水酒精和浓硫酸混合加热制取：
    \begin{center}
        \ce{C2H5OH ->T[\text{浓}\ce{H2SO4}][$170^\circ$C] H2O + C2H4 ^}\\[5mm]
    \end{center}
    ...
    \begin{center}
        \ce{5C2H4 + 12KMnO4 + 18H2SO4 -> 10CO2 + 12MnSO4 + 6K2SO4 + 28H2O}\\[4mm]
    \end{center}
...
\newpage
    ...
    \begin{center}
        ...
        \schemestart
            ...
            \ce{HBr}
            ~~~\arrow(foo.mid east--bar.mid west){->[\footnotesize 催化剂][\footnotesize 加热]}~~~~
            \chemname[5pt]{\chemfig{C(-[2]H)(-[4]H)(-[6]H)-C(-[2]H)(-[0]H)(-[6]Br)}}{溴乙烷}
        \schemestop
    \end{center}\vspace{15pt}
    乙烯可以通过和水的加成反应生成乙醇：
    \begin{center}
        ...
        \schemestart
            ...
            \+{12pt,10pt,1pt}
            \ce{H2O}
            ~~~\arrow(foo.mid east--bar.mid west){->[\footnotesize 催化剂][\footnotesize $260^\circ$C]}~~~~
            \chemname[5pt]{\chemfig{C(-[2]H)(-[4]H)(-[6]H)-C(-[2]H)(-[0]OH)(-[6]H)}}{乙醇}
        \schemestop
    \end{center}\vspace{25pt}
...
\subsubsection{烯烃}
    ...
    烯烃的分子式可以使用通式\ce{C_{n}H_{2n}}表示。\\[5mm]
...
\subsubsection{丁二烯}
    丁二烯，无色易液化气体，熔点$-109^\circ$C，沸点$-4^\circ$C。\\[3mm]
    丁二烯\ce{C4H6}是较典型的二烯烃，结构式为：\vspace{5pt}
    \begin{center}
        \chemnameinit{\chemfig{C(-[4]H)(-[6]H)=C(-[6]H)(-[0]H)}}
        \setchemfig{atom sep=15pt}
        \setchemfig{fixed length=true}
        \chemname[5pt]
        {
            \chemfig
            {
                H-C(-[6]H)=C(-[6]H)-C(-[6]H)=C(-[6]H)-H
            }
        }{丁二烯}
    \end{center}\vspace{10pt}
    有机物的加成反应：有机物分子中通过连接其他原子团使得不饱和键断裂的反应。\\[3mm]
    丁二烯可以发生1,2-加成反应（相对较少）：
    \begin{center}
        \setchemfig{atom sep=15pt}
        \setchemfig{fixed length=true}
        \setchemfig{arrow coeff=0.8}
        ...
        \schemestart
            \chemfig{H-C(-[6]H)=C(-[6]H)-C(-[6]H)=C(-[6]H)-H}
            \+{12pt,10pt,1pt}
            \ce{Br_2}
            ~~~~~\arrow(foo.mid east--bar.mid west){->}~~~~
            \chemfig{H-C(-[6]H)=C(-[6]H)-C(-[6]H)(-[2]Br)-C(-[6]H)(-[2]Br)-H}
        \schemestop
    \end{center}\vspace{20pt}
    丁二烯可以发生1,4-加成反应（相对较多）：
    \begin{center}
        \chemnameinit{\chemfig{H-C(-[6]H)(-[2]Br)-C(-[6]H)(-[2]Br)-C(-[6]H)=C(-[6]H)-H}}
        \setchemfig{atom sep=15pt}
        \setchemfig{fixed length=true}
        \setchemfig{arrow coeff=0.8}
        ...
        \schemestart
            ...
            \ce{Br_2}
            ~~~~~\arrow(foo.mid east--bar.mid west){->}~~~~
            \chemfig{H-C(-[6]H)(-[2]Br)-C(-[6]H)=C(-[6]H)-C(-[6]H)(-[2]Br)-H}
        \schemestop
    \end{center}\vspace{20pt}
    丁二烯和乙烯可以通过1,4-加成得到环状产物（狄尔斯–阿尔德反应）：\vspace{5pt}
    \begin{center}
        \chemnameinit{\chemfig{H-C(-[6]H)(-[2]Br)-C(-[6]H)(-[2]Br)-C(-[6]H)=C(-[6]H)-H}}
        \setchemfig{atom sep=15pt}
        \setchemfig{fixed length=true}
        ...
        \schemestart
            \chemfig{H-C(-[6]H)=C(-[6]H)-C(-[6]H)=C(-[6]H)-H}
            \+{12pt,10pt,1pt}
            \chemfig{H-C(-[6]H)=C(-[6]H)-H}
            ~~~~~\arrow(foo.mid east--bar.180){->}~~~~
            \chemfig{*6(-----=)}
        \schemestop
    ...
    \begin{center}
        ...
        \schemestart
            \chemfig{nCH_2=CH-CH=CH_2}
            ~~~~~\arrow(foo.mid east--bar.mid west){->[\footnotesize 一定条件]}~~~~
            \chemfig{\text{\big[}-CH_2-CH=CH-CH_2-\text{\big]$_n$}}
        \schemestop
...
\subsubsection{二烯烃}
    ...
    二烯烃的分子式可以使用通式\ce{C_{n}H_{2n-2}}表示。\\[5mm]
...
\newpage
    ...
    \begin{center}
        ...
        \schemestart
            ...
            \ce{HBr}
            ~~~\arrow(foo.mid east--bar.mid west){->[\footnotesize 催化剂][\footnotesize 加热]}~~~~
            \chemname[5pt]{\chemfig{C(-[4]H)(-[6]H)=C(-[0]H)(-[6]Br)}}{溴乙烯}
        \schemestop
    \end{center}\vspace{15pt}
    乙炔可以通过和水的加成反应生成乙醛：
    \begin{center}
        ...
        \schemestart
            ...
            \+{12pt,10pt,1pt}
            \ce{H2O}
            ~~~\arrow(foo.mid east--bar.mid west){->[\footnotesize 催化剂][\footnotesize $100^\circ$C]}~~~~
    ...
    \begin{center}
        ...
        \schemestart
            \chemfig{nCH~CH}
            ~~~~~\arrow(foo.mid east--bar.mid west){->[\footnotesize 一定条件]}~~~~
            \chemfig{\text{\big[}-CH=CH-\text{\big]$_n$}}
        \schemestop
    \end{center}\vspace{10pt}
    氯乙烯可以通过聚合反应生成聚氯乙烯：
    \begin{center}
        ...
        \schemestart
            \chemfig{nCH2=CH(-[6]Cl)}
            ~~~~~\arrow(foo.mid east--bar.mid west){->[\footnotesize 一定条件]}~~~~
            \chemfig{\text{\big[}-CH2-CH(-[6]Cl)-\text{\big]$_n$}}
        \schemestop
    \end{center}\vspace{10pt}
...
\subsubsection{炔烃}
    ...
    炔烃的分子式可以使用通式\ce{C_{n}H_{2n-2}}表示。\\[5mm]
    以下列出了一些常见的却听你：\vspace{5pt}
    \begin{center}
        \chemnameinit{\chemfig{C(-[4]H)(-[6]H)=C(-[6]H)(-[0]H)}}
        \setchemfig{atom sep=15pt}
        \setchemfig{fixed length=true}
    ...
    \begin{center}
        ...
        \chemname[5pt]
        {
            \chemfig
            {
                CH_3-CH_2-CH(-[6]CH_3)-CH_2-CH(-[6]CH_2-[6]CH_3)-CH-C~CH
            }
        }{6-甲基-4-乙基-1-辛炔}
    \end{center}
...
\subsubsection{苯}
    苯，无色液体，密度$0.88\text{g}/\text{cm}^3$，轻于水，熔点$6^\circ$C，沸点$78^\circ$C。\\[3mm]
    苯（\ce{C6H6}）是最简单的芳香烃，结构式为：\vspace{10pt}
    \begin{center}
    ...
    苯可以在空气中燃烧，火焰明亮伴有黑烟：
    \begin{center}
        \ce{2C6H6 + 15O2 ->T[点燃] 12CO2 + 6H2O}\\[5mm]
    \end{center}
    苯可以和氢气发生加成反应：
    \begin{center}
        ...
        \schemestart
            ...
            \chemfig{H_2}
            ~~~~~\arrow(c2.mid east--c3.150){->[\footnotesize \ce{Ni}][\footnotesize 加热]}~~~~
    ...
    \begin{center}
        ...
        \schemestart
            ...
            \arrow(c1.40--c2.mid west){0}[,0]\+{12pt,10pt,1pt}
            \chemfig{3Cl_2}
            ~~~~~\arrow(c2.mid east--c3.165){->[\footnotesize 紫外线]}~~~~
...
\newpage
    ...
    \begin{center}
        ...
        \schemestart
            ...
            \chemname[15pt]{\chemfig{[:30]*6(=-(-Cl)=-=-)}}{氯苯}
    ...
    该实验操作时，会将气体导出检验，首先通过~\ce{CCl4}以吸收~\ce{Br2}，然后通入~\ce{AgNO3}以检验~\ce{HBr}，
    观察到产生了淡黄色的溴化银沉淀，这一现象说明了该反应产生了溴化氢气体。\\[3mm]
    虽然溴苯本身无色，但是反应得到的溴苯中溶解了溴，故表现为褐色的油状液体。\\[3mm]
    反应直接得到的溴苯称为粗溴苯，其中含有的物质有：苯，溴苯，溴化铁，溴，铁。\\[6mm]
    将粗溴苯提纯的过程分为五步：\\[3mm]
    1.过滤~~~~通过过滤可以除去固体性杂质（\ce{Fe}）\\[3mm]
    2.水洗~~~~通过水洗可以除去水溶性杂质（\ce{FeBr3}）\\[3mm]
    3.碱洗~~~~通过氢氧化钠和溴反应除去溴（\ce{Br2}）\\[3mm]
    4.水洗~~~~通过水洗可以除去水溶性杂质（\ce{NaBr}~~\ce{NaBrO}~~\ce{NaOH}）\\[3mm]
    5.蒸馏~~~~通过沸点上的差异可以除去苯（\ce{C6H6}）\\[6mm]
    其中水洗的原理在于通过加入水溶解水溶性杂质，随后通过分液漏斗进行分液，使得互不相溶的水层和有机层分离，
    保留无杂质的有机层，抛弃有杂质的水层，由此除去了水溶性杂质。\\[3mm]
    其中的碱洗中所用的氢氧化钠和溴的反应为：
    \begin{center}
        \ce{2NaOH + Br_2 -> NaBr + NaBrO + H2O}\\[3mm]
    \end{center}
...
\newpage
    ...
    将粗硝基苯提纯的过程分为四步：\\[3mm]
    1.水洗~~~~通过水洗可以除去水溶性杂质（\ce{H2SO4}~~\ce{HNO3}）\\[3mm]
    2.碱洗~~~~通过氢氧化钠与二氧化氮反应（\ce{NO2}）\\[3mm]
    3.水洗~~~~通过水洗可以除去水溶性杂质（\ce{NaNO3}~~\ce{NaNO2}~~\ce{NaOH}）\\[3mm]
    4.蒸馏~~~~通过沸点上的差异可以除去苯（\ce{C6H6}）\\[6mm]
    其中的碱洗中所用的氢氧化钠和二氧化氮的反应为：
    \begin{center}
        \ce{2NO2 + 2NaOH -> NaNO3 + NaNO2 + H2O}\\[3mm]
    \end{center}
    因此第二次水洗时，不仅除去了多余的氢氧化钠，同时除去了反应得到的硝酸钠和亚硝酸钠。

\newpage

    甲苯可以和溴发生烷基取代：\vspace{10pt}
    \begin{center}
        \chemnameinit{\chemfig{[:30]*6(=-=-=-)}}
        \setchemfig{atom sep=15pt}
        \setchemfig{fixed length=true}
        ...
        \schemestart
            ...
            \chemfig{Br_2}
            ~~~~~\arrow(c2.mid east--c3.180){->[\footnotesize 光照]}~~~~
            \chemfig{[:30]*6(=-(-CH_2-Br)=-=-)}
            \arrow(c3.-2--c4.mid west){0}[,0]\+{12pt,10pt,1pt}
            \chemfig{HBr}
        \schemestop
    \end{center}\vspace{15pt}
    甲苯可以和溴发生苯环取代：
    \begin{center}
        ...
        \schemestart
            ...
            \arrow(c1.19--c2.mid west){0}[,0]\+{12pt,10pt,1pt}
            \chemfig{3Br_2}
            ~~~~~\arrow(c2.mid east--c3.173){->[\footnotesize 催化剂]}~~~~
            \chemname[15pt]{\chemfig{[:30]*6(=(-Br)-(-CH_3)=(-Br)-=(-Br)-)}}{~}
            \arrow(c3.7--c4.mid west){0}[,0]\+{12pt,10pt,1pt}
            \chemfig{3HBr}
        \schemestop
    \end{center}\vspace{2pt}
    由此可见，甲苯可以使得苯环活化，使得发生取代反应时主要进入它的邻对位。\\[3mm]
    这一类苯环上的取代基称为邻对位定位基：烷基（\ce{-CH3}），羟基（\ce{-OH}），氨基（\ce{NH2}）。\\[12mm]
    硝基苯可以和溴发生苯环取代：
    \begin{center}
        \chemnameinit{\chemfig{[:30]*6(=-=-=-)}}
        \setchemfig{atom sep=15pt}
        ...
        \schemestart
            ...
            \arrow(c1.19--c2.mid west){0}[,0]\+{12pt,10pt,1pt}
            \chemfig{2Br_2}
            ~~~~~\arrow(c2.mid east--c3.171){->[\footnotesize 催化剂]}~~~~
            \chemname[15pt]{\chemfig{[:30]*6(=-(-NO_2)=-(-Br)=-)(-[:-120]Br)}}{~}
            \arrow(c3.8--c4.mid west){0}[,0]\+{12pt,10pt,1pt}
            \chemfig{2HBr}
        \schemestop
    \end{center}\vspace{2pt}
    由此可见，硝基可以使得苯环钝化，使得发生取代反应时主要进入它的间位。\\[3mm]
    这一类苯环上的取代基称为间位定位基：硝基（\ce{-CH3}），磺酸基（\ce{-SO_3H}）。
...
\newpage
    ...
    \begin{center}
        ...
        \schemestart
            ...
            \chemname[15pt]{\chemfig{[:30]*6(=(-NO_2)-(-CH_3)=(-NO_2)-=(-NO2)-)}}{三硝基甲苯}
...
\newpage
    ...
    \begin{center}
        \chemnameinit{\chemfig{*6(=-=-(-CH_3)=-)}}
        \setchemfig{atom sep=15pt}
        \setchemfig{fixed length=true}
        \setchemfig{arrow coeff=0.8}
        \schemestart
            5~~~~\arrow(c1.mid east--c2.170){0}[,0]
            \chemname[5pt]{\chemfig{*6(=-=-(-CH_3)=-)}}{甲苯}
            ...
            \chemname[5pt]{\chemfig{*6(=-=-(-COOH)=-)}}{苯甲酸}
    ...
    \begin{center}
        \chemnameinit{\chemfig{*6(=-=-(-C_2H_5)=-)}}
        \setchemfig{atom sep=15pt}
        \setchemfig{fixed length=true}
        \setchemfig{arrow coeff=0.8}
        \schemestart
            5~~~~\arrow(c1.mid east--c2.170){0}[,0]
            \chemname[5pt]{\chemfig{*6(=-=-(-C_2H_5)=-)}}{乙苯}
            \arrow(c1.10--c2.mid west){0}[,0]\+{4pt,4pt,1pt}
            \chemfig{12KMnO_4}
            \+{2pt,2pt,1pt}
            \chemfig{18H_2SO_4}
...
\subsubsection{单环芳烃}
    ...
    单环芳烃的分子式可以使用通式\ce{C_nH_{2n-6}}表示。\\[6mm]
    ...
    \end{center}\vspace{20pt}
    含有两个相同取代基的单环芳烃可以采用以下习惯命名：\vspace{8pt}
    \begin{center}
        \chemnameinit{\chemfig{[:30]*6(=-=-=-)}}
        \setchemfig{atom sep=15pt}
        \setchemfig{fixed length=true}
    ...
    \end{center}\vspace{30pt}
    含有三个相同取代基的单环芳烃可以采用以下习惯命名：\vspace{8pt}
    \begin{center}
...
\newpage
    ...
    以下列出了部分使用系统命名法的单环烷烃：\vspace{15pt}
    \begin{center}
...
\subsubsection{稠环芳烃}
    稠环芳烃指的是分子中包含多个苯环且共用相邻碳原子的碳氢化合物。\\[5mm]
...
\subsubsection{卤代烃}
    卤代烃指的是一类含有卤原子（\ce{-X}）的有机化合物。\\[3mm]
    卤代烃中如果仅含有一个卤原子，其分子式可以用通式\ce{C_nH_{2n-1}X}表示。\\[3mm]
    卤代烃中以液体和固体为主，只有三种物质是气体，一氯甲烷，一氯乙烷，一溴甲烷。\\[3mm]
    乙烯可以和溴水中的溴发生加成反应，生成二溴乙烷：\vspace{10pt}
    \begin{center}
        \chemnameinit{\chemfig{C(-[4]H)(-[6]H)=C(-[0]H)(-[6]Cl)}}
        \setchemfig{atom sep=15pt}
        \setchemfig{fixed length=true}
        ...
        \schemestart
            \chemname[5pt]{\chemfig{H-C(-[2]H)=C(-[2]H)-H}}{乙烯}
            \+{12pt,10pt,1pt}
            \ce{Br2}
            ~~~~\arrow(foo.mid east--bar.mid west){->}~~~~
            \chemname[5pt]{\chemfig{H-C(-[2]H)(-[6]Br)-C(-[2]H)(-[6]Br)-H}}{二溴乙烷}~~~~~~~~~~~~~~~~~~~~~~
        \schemestop
    \end{center}\vspace{20pt}
    乙烷可以和液溴中的溴发生取代反应，生成一溴乙烷：\vspace{10pt}
    \begin{center}
        \chemnameinit{\chemfig{C(-[4]H)(-[6]H)=C(-[0]H)(-[6]Cl)}}
        \setchemfig{atom sep=15pt}
        \setchemfig{fixed length=true}
        ...
        \schemestart
            \chemname[5pt]{\chemfig{H-C(-[2]H)(-[6]H)-C(-[2]H)(-[6]H)-H}}{乙烷}
            \+{12pt,10pt,1pt}
            \ce{Br2}
            ~~~~\arrow(foo.mid east--bar.mid west){->[\footnotesize 光照]}~~~~
            \chemname[5pt]{\chemfig{H-C(-[2]H)(-[6]H)-C(-[2]H)(-[6]H)-Br}}{一溴乙烷}
            \+{12pt,10pt,1pt}
            \ce{H2O}
        \schemestop
    \end{center}\vspace{20pt}
    乙醇可以和溴化氢溶液发生取代反应，生成一溴乙烷：\vspace{10pt}
    \begin{center}
        \chemnameinit{\chemfig{C(-[4]H)(-[6]H)=C(-[0]H)(-[6]Cl)}}
        \setchemfig{atom sep=15pt}
        \setchemfig{fixed length=true}
...
\newpage
    ...
    有机物的取代反应：有机物分子中的某些原子团被其他原子团取代的反应。\\[3mm]
    一氯乙烷可以和氢氧化钠的水溶液发生取代反应：\vspace{10pt}
    \begin{center}
        \chemnameinit{\chemfig{C(-[4]H)(-[6]H)=C(-[0]H)(-[6]Cl)}}
        \setchemfig{atom sep=15pt}
        \setchemfig{fixed length=true}
        ...
        \schemestart
            \chemname[5pt]{\chemfig{H-C(-[2]H)(-[6]H)-C(-[2]H)(-[6]Cl)-H}}{一氯乙烷}
            \+{12pt,10pt,1pt}
            \ce{NaOH}
            ~~~~\arrow(foo.mid east--bar.mid west){->[\footnotesize 水][\footnotesize 加热]}~~~~
            \chemname[5pt]{\chemfig{H-C(-[2]H)(-[6]H)-C(-[2]H)(-[6]OH)-H}}{乙醇}
            \+{12pt,10pt,1pt}
            \ce{NaCl}
        \schemestop
    \end{center}\vspace{20pt}
    二氯乙烷可以和氢氧化钠的水溶液发生取代反应：\vspace{10pt}
    \begin{center}
        \chemnameinit{\chemfig{C(-[4]H)(-[6]H)=C(-[0]H)(-[6]Cl)}}
        \setchemfig{atom sep=15pt}
        \setchemfig{fixed length=true}
        ...
        \schemestart
            \chemname[5pt]{\chemfig{H-C(-[2]H)(-[6]Cl)-C(-[2]H)(-[6]Cl)-H}}{二氯乙烷}
            \+{10pt,8pt,1pt}
            \ce{2NaOH}
            ~~~~\arrow(foo.mid east--bar.mid west){->[\footnotesize NaOH~~水][\footnotesize 加热]}~~~~
            \chemname[5pt]{\chemfig{H-C(-[2]H)(-[6]OH)-C(-[2]H)(-[6]OH)-H}}{乙二醇}
            \+{10pt,8pt,1pt}
            \ce{2NaCl}
        \schemestop
    \end{center}\vspace{10pt}
    需要说明的是，此处二氯乙烷的取代反应，只可以使用1,2-二氯乙烷，不可以使用1,1-二氯乙烷。\\[8mm]
    有机物的消去反应：有机物分子中通过断开某些原子团使得不饱和键形成的反应。\\[3mm]
    一氯乙烷可以和氢氧化钠的醇溶液发生取代反应：\vspace{10pt}
    \begin{center}
        \chemnameinit{\chemfig{C(-[4]H)(-[6]H)=C(-[0]H)(-[6]Cl)}}
        \setchemfig{atom sep=15pt}
        \setchemfig{fixed length=true}
        ...
        \schemestart
            ...
            \+{12pt,10pt,1pt}
            \ce{NaOH}
            ~~~~\arrow(foo.mid east--bar.mid west){->[\footnotesize 醇][\footnotesize 加热]}~~~~
            \chemname[5pt]{\chemfig{H-C(-[2]H)=C(-[2]H)-H}}{乙烯}
            \+{12pt,10pt,1pt}
            \ce{NaCl}
            \+{10pt,10pt,1pt}
        ...
        \schemestop
    \end{center}\vspace{20pt}
    二氯乙烷可以和氢氧化钠的醇溶液发生取代反应：\vspace{10pt}
    \begin{center}
        \chemnameinit{\chemfig{C(-[4]H)(-[6]H)=C(-[0]H)(-[6]Cl)}}
        \setchemfig{atom sep=15pt}
        \setchemfig{fixed length=true}
        ...
        \schemestop
    \end{center}\vspace{10pt}
    需要说明的是，此处二氯乙烷的取代反应，既可以使用1,2-二氯乙烷，也可以使用1,1-二氯乙烷。
...
\subsubsection{乙醇}
    ...
    \begin{center}
        ...
        \schemestart
            ...
            \ce{2Na}
            ~~~~\arrow(foo.mid east--bar.mid west){->}~~~~
            2~~\chemname[5pt]{\chemfig{H-C(-[2]H)(-[6]H)-C(-[2]H)(-[6]H)-ONa}}{乙醇钠}
            \+{12pt,10pt,1pt}
            \ce{H_2 ^}
        \schemestop
    \end{center}\vspace{15pt}
...
\newpage
    ...
    \begin{center}
        ...
        \schemestop
    \end{center}\vspace{20pt}
    其中上述乙醇后两个生成乙烯和乙醚的反应，由于均脱下了一份水，因此也被称为脱水反应。\\[3mm]
    乙醇脱水生成乙烯的反应中，由于羟基和氢来源于一个乙醇分子，故称为分子内脱水。\\[3mm]
    乙醇脱水生成乙醚的反应中，由于羟基和氢来源于两个乙醇分子，故称为分子间脱水。

\newpage

    乙醇可以通过和氯化氢的取代反应，生成氯乙烷：\vspace{10pt}
    \begin{center}
        \chemnameinit{\chemfig{C(-[4]H)(-[6]H)=C(-[0]H)(-[6]Cl)}}
        \setchemfig{atom sep=15pt}
        \setchemfig{fixed length=true}
        ...
        \schemestart
            ...
            \ce{HCl}
            ~~~~\arrow(foo.mid east--bar.mid west){->[\footnotesize 催化剂][\footnotesize 加热]}~~~~
            \chemname[5pt]{\chemfig{H-C(-[2]H)(-[6]H)-C(-[2]H)(-[6]H)-Cl}}{氯乙烷}
            \+{12pt,10pt,1pt}
            \ce{H2O}
        \schemestop
    \end{center}\vspace{10pt}
    乙醇可以通过和溴化氢的取代反应，生成溴乙烷：\vspace{10pt}
    \begin{center}
        \chemnameinit{\chemfig{C(-[4]H)(-[6]H)=C(-[0]H)(-[6]Cl)}}
        \setchemfig{atom sep=15pt}
        \setchemfig{fixed length=true}
        ...
        \schemestart
            ...
            \chemname[5pt]{\chemfig{H-C(-[2]H)(-[6]H)-C(-[2]H)(-[6]H)-Br}}{溴乙烷}
            \+{12pt,10pt,1pt}
            \ce{H2O}
        \schemestop
    \end{center}\vspace{10pt}
    第一个反应中的取代产物氯乙烷是无色易液化气体，密度为$0.92\text{g}/\text{cm}^3$，轻于水。\\[3mm]
    第二个反应中的取代产物溴乙烷是无色的油状液体，密度为$1.47\text{g}/\text{cm}^3$，重于水。\\[10mm]
    ...
    因此醇醛两者的关系可以表示如下：
    \begin{center}
        \ce{\text{~~醇（\ce{-OH}）} <=>T[加~\ce{O2}氧化][加~\ce{H2}还原] \text{~~醛（\ce{-CHO}）}}\\[3mm]
    \end{center}
    由此可见，醇可以加氧氧化为醛，醛可以加氢还原为醇。

\newpage

\subsubsection{醇类}
    醇指的是一类含有醇羟基（\ce{-OH}）的碳氢氧化合物。\\[3mm]
    醇中如果仅含有一个醇羟基，其分子式可以用通式\ce{C_nH_{2n+2}O}表示。\\[3mm]
    ...
    \begin{center}
        \chemnameinit{\chemfig{CH_3-CH(-[6]OH)-CH_2-CH_3}}
        \setchemfig{atom sep=15pt}
        \setchemfig{fixed length=true}
        \chemname[15pt]
        {
        ...
        \chemname[15pt]
        {
            \chemfig
            {
                CH_3-CH_2-CH(-[6]OH)-CH_2-CH_3
            }
        }{3-戊醇}
    \end{center}\vspace{5pt}
    \begin{center}
        \chemnameinit{\chemfig{CH_3-CH_2-CH(-[6]OH)-CH_2-CH(-[6]CH_3)-CH_3}}
        \setchemfig{atom sep=15pt}
        \setchemfig{fixed length=true}
        \chemname[5pt]
        {
            \chemfig
            {
                CH_3-CH_2-CH(-[6]OH)-CH_2-CH(-[6]CH_3)-CH_3
            }
        }{5-甲基-3-己醇}
    \end{center}\vspace{20pt}
    甲醇为无色具有特殊香味的液体，甲醇俗称木精。\\[3mm]
    乙醇为无色具有特殊香味的液体，乙醇俗称酒精。

\newpage

    羟基连接于伯碳（一级碳原子）的醇称为伯醇或一级醇。\\[3mm]
    羟基连接于仲碳（二级碳原子）的醇称为仲醇或二级醇。\\[3mm]
    伯醇（以1-丙醇为例）的氧化产物是醛：\vspace{10pt}
    \begin{center}
        \chemnameinit{\chemfig{C(-[4]H)(-[6]H)=C(-[0]H)(-[6]Cl)}}
        \setchemfig{atom sep=15pt}
        \setchemfig{fixed length=true}
        ...
        \schemestart
            ~~~~~~~~2~~\chemname[5pt]{\chemfig{H-C(-[2]H)(-[6]H)-C(-[2]H)(-[6]H)-C(-[2]OH)(-[6]H)-H}}{1-丙醇}
            \+{12pt,10pt,1pt}
            \ce{O_2}
            ~~~~\arrow(foo.mid east--bar.mid west){->[\footnotesize \ce{Cu}~/~\ce{Ag}][\footnotesize 加热]}~~~~
            2~~\chemname[5pt]{\chemfig{H-C(-[2]H)(-[6]H)-C(-[2]H)(-[6]H)-C(=[2]O)-H}}{丙醛}
            \+{12pt,10pt,1pt}
            \ce{2H_2O}
        \schemestop
    \end{center}\vspace{15pt}
    仲醇（以2-丙醇为例）的氧化产物是酮：\vspace{10pt}
    \begin{center}
        \chemnameinit{\chemfig{C(-[4]H)(-[6]H)=C(-[0]H)(-[6]Cl)}}
        \setchemfig{atom sep=15pt}
        \setchemfig{fixed length=true}
        ...
        \schemestart
            ~~~~~~~~2~~\chemname[5pt]{\chemfig{H-C(-[2]H)(-[6]H)-C(-[2]OH)(-[6]H)-C(-[2]H)(-[6]H)-H}}{2-丙醇}
            \+{12pt,10pt,1pt}
            \ce{O_2}
            ~~~~\arrow(foo.mid east--bar.mid west){->[\footnotesize \ce{Cu}~/~\ce{Ag}][\footnotesize 加热]}~~~~
            2~~\chemname[5pt]{\chemfig{H-C(-[2]H)(-[6]H)-C(=[2]O)-C(-[2]H)(-[6]H)-H}}{丙酮}
            \+{12pt,10pt,1pt}
            \ce{2H_2O}
        \schemestop
    \end{center}\vspace{15pt}
    羟基的数量为$1$的醇称为一元醇。\\[3mm]
    羟基的数量为$2$的醇称为二元醇。\\[3mm]
    羟基的数量为$3$的醇称为三元醇。\\[3mm]
    乙二醇是最简单的二元醇：\vspace{8pt}
    \begin{center}
        \chemnameinit{\chemfig{H-C(-[2]H)(-[6]H)-C(-[2]H)(-[6]H)-OH}}
        \setchemfig{atom sep=15pt}
        \setchemfig{fixed length=true}
    ...
    \end{center}\vspace{15pt}
    乙二醇为无色黏稠具有甜味的液体，乙二醇俗称甘醇。\\[3mm]
    丙三醇为无色黏稠具有甜味的液体，丙三醇俗称甘油。

\newpage

\subsubsection{醚类}
    醚指的是一类含有醚键（\ce{-O-}）的碳氢氧化合物。\\[3mm]
    醚中如果仅含有一个醚键，其分子式可以用通式\ce{C_{n}H_{2n+2}O}表示。\\[3mm]
    以下列出了一些常见的醚：\vspace{8pt}
    \begin{center}
        \chemnameinit{\chemfig{H-C(-[2]H)(-[6]H)-C(-[2]H)(-[6]H)-OH}}
        \setchemfig{atom sep=15pt}
        \setchemfig{fixed length=true}
    ...
    \begin{center}
        ...
        \schemestart
            2~~\chemname[5pt]{\chemfig{H-C(-[2]H)(-[6]H)-OH}}{甲醇}
            ~~~~\arrow(foo.mid east--bar.mid west){->[\footnotesize 浓\ce{H2SO4}][\footnotesize 加热]}~~~~
            \chemname[5pt]{\chemfig{H-C(-[2]H)(-[6]H)-O-C(-[2]H)(-[6]H)-H}}{甲醚}
            \+{12pt,10pt,1pt}
            \ce{H2O}
        \schemestop
    \end{center}\vspace{20pt}
    乙醇可以通过分子间脱水，生成乙醚：\vspace{10pt}
    \begin{center}
        \chemnameinit{\chemfig{C(-[4]H)(-[6]H)=C(-[0]H)(-[6]Cl)}}
        \setchemfig{atom sep=15pt}
        \setchemfig{fixed length=true}
    ...
    \begin{center}
        \chemnameinit{\chemfig{CH_3-CH_2-O-CH_2-CH_3}}
        \setchemfig{atom sep=15pt}
        \setchemfig{fixed length=true}
        \chemname[10pt]
        {
    ...
    \begin{center}
        \chemnameinit{\chemfig{CH_3-O-CH_2-CH_3}}
        \setchemfig{atom sep=15pt}
        \setchemfig{fixed length=true}
        \chemname[10pt]
        {
...
\subsubsection{苯酚}
    苯酚，无色针状晶体，密度$1.07\text{g}/\text{cm}^3$，熔点$41^\circ$C，沸点$182^\circ$C。\\[3mm]
    ...
    \end{center}\vspace{10pt}
    酚类大多具有很强的杀菌能力，苯酚在历史上曾经用于外科手术用具的消毒，但由于毒性较大，现已经很少使用，
    然而衡量消毒剂杀菌能力的苯酚系数则使用至今，其指的是相同浓度的消毒剂和苯酚在单位时间内杀死的细菌数之比，
    性能越强苯酚系数越大，性能越弱苯酚系数越小。\\[3mm]
    苯酚在空气中易被氧化为苯醌：\vspace{10pt}
    \begin{center}
        \chemnameinit{\chemfig{[:30]*6(=-=-=-)}}
        \setchemfig{atom sep=15pt}
        \setchemfig{fixed length=true}
        ...
        \schemestart
            \chemname[15pt]{\chemfig{[:30]*6(=-(-OH)=-=-)}}{苯酚}
            \arrow(c1.20--c2.-179){0}[,0]\+{12pt,10pt,1pt}
            \chemfig{O_2}
            ~~~~~\arrow(c2.mid east--c3.165){->}~~~~
            \chemname[15pt]{\chemfig{[:30]*6(=-(=O)-=-(=O)-)}}{苯醌}
        \schemestop
    \end{center}\vspace{10pt}
    苯酚呈无色，苯醌呈粉红色，因此暴露于空气的苯酚容易被氧化为粉红色。\\[6mm]
    苯酚可以和碱反应生成苯酚钠：\vspace{10pt}
    \begin{center}
        \chemnameinit{\chemfig{[:30]*6(=-=-=-)}}
        \setchemfig{atom sep=15pt}
        \setchemfig{fixed length=true}
        ...
        \schemestart
            ...
            \chemname[15pt]{\chemfig{[:30]*6(=-(-ONa)=-=-)}}{苯酚钠}
            \arrow(c3.16--c2.mid west){0}[,0]\+{12pt,10pt,1pt}
            \chemfig{H_2O}
        \schemestop
    \end{center}\vspace{20pt}
...
\newpage
    ...
    \begin{center}
        ...
        \schemestart
            ...
            \chemname[15pt]{\chemfig{[:30]*6(=(-Br)-(-OH)=(-Br)-=(-Br)-)}}{三溴苯酚}
            \arrow(c3.13--c4.mid west){0}[,0]\+{12pt,10pt,1pt}
            \chemfig{3HBr}
        \schemestop
    \end{center}\vspace{10pt}
    ...
    \begin{center}
        ...
        \schemestart
            ...
            \chemfig{3HNO_3}
            ~~~~~\arrow(c2.mid east--c3.167){->}~~~~
            \chemname[15pt]{\chemfig{[:30]*6(=(-NO_2)-(-OH)=(-NO_2)-=(-NO2)-)}}{三硝基苯酚}
            \arrow(c3.13--c4.mid west){0}[,0]\+{12pt,10pt,1pt}
            \chemfig{3H_2O}
        \schemestop
    \end{center}\vspace{10pt}
...
\subsubsection{酚类}
    酚指的是一类含有酚羟基（-OH）的碳氢化合物。\\[3mm]
    酚中如果仅含有一个酚羟基，其分子式可以用通式\ce{C_{n}H_{2n-6}O}表示。\\[3mm]
    酚的羟基必须直接连接于苯环，否则应当称其为醇。\\[3mm]
    以下列出了一些常见的酚：\vspace{5pt}
    \begin{center}
        \chemnameinit{\chemfig{[:30]*6(=-=-=-)}}
        \setchemfig{atom sep=15pt}
        \setchemfig{fixed length=true}
...
\subsubsection{乙醛}
    乙醛，无色液体，密度$0.79\text{g}/\text{cm}^3$，轻于水，熔点$-124^\circ$C，沸点$20^\circ$C。\\[3mm]
    ...
    乙醛可以在空气中燃烧：
    \begin{center}
        \ce{2C2H4O + 3O2 ->T[点燃] 2CO2 + 4H2O}\\[6mm]
    \end{center}
    乙醛可以通过乙烯的氧化制得：\vspace{-2pt}
    \begin{center}
        \chemnameinit{\chemfig{C(-[4]H)(-[6]H)=C(-[0]H)(-[6]Cl)}}
        \setchemfig{atom sep=15pt}
        \setchemfig{fixed length=true}
        ...
        \schemestart
            2~~\chemname[5pt]{\chemfig{H-C(-[6]H)=C(-[6]H)-H}}{乙烯}
            \+{12pt,10pt,1pt}
            \ce{O2}
            ~~~\arrow(foo.mid east--bar.mid west){->[\footnotesize 催化剂][\footnotesize 加热加压]}~~~~
            2~~\chemname[5pt]{\chemfig{H-C(-[2]H)(-[6]H)-C(=[2]O)-H}}{乙醛}
        \schemestop
    \end{center}\vspace{18pt}
    乙醛可以通过乙炔的水化制得：\vspace{-2pt}
    \begin{center}
        \chemnameinit{\chemfig{C(-[4]H)(-[6]H)=C(-[0]H)(-[6]Cl)}}
        \setchemfig{atom sep=15pt}
        \setchemfig{fixed length=true}
        ...
        \schemestop
    \end{center}\vspace{18pt}
    乙烯氧化反应常用的催化剂是氯化钯和氯化铜（\ce{PdCl2-CuCl2}）。\\[3mm]
    乙炔水化反应常用的催化剂是硫酸汞（\ce{HgSO4}）。
...
\newpage
    ...
    \begin{center}
        ...
        \schemestop
    \end{center}\vspace{15pt}
    乙醛可以和氧气发生氧化反应，氧化生成乙酸：\vspace{8pt}
    \begin{center}
        \chemnameinit{\chemfig{C(-[4]H)(-[6]H)=C(-[0]H)(-[6]Cl)}}
        \setchemfig{atom sep=15pt}
        \setchemfig{fixed length=true}
        ...
        \schemestart
            ...
            \+{12pt,10pt,1pt}
            \ce{O_2}
            ~~~~\arrow(foo.mid east--bar.mid west){->[\footnotesize \ce{MnAc2}][\footnotesize 加热]}~~~~
            2~~\chemname[5pt]{\chemfig{H-C(-[2]H)(-[6]H)-C(=[2]O)-OH}}{乙酸}~~~~~~~~~~~~~~~~~~
        \schemestop
    \end{center}\vspace{15pt}
    乙醛可以和氢气发生加成反应，还原生成乙醇：\vspace{8pt}
    \begin{center}
        ...
        \schemestop
    \end{center}\vspace{15pt}
    因此醇醛酸三者的关系可以表示如下：\vspace{5pt}
    \begin{center}
        \ce{\text{~~醇（\ce{-OH}）~~} <=>T[加~\ce{O2}氧化][加~\ce{H2}还原] \text{~~~~醛（\ce{-CHO}）}} \ce{->T[加~\ce{O2}氧化] \text{~~~~酸（\ce{-COOH}）}}\\[3mm]
    \end{center}\vspace{5pt}
    由此可见，醇可以加氧氧化为醛，醛可以加氧氧化为酸，醛可以加氢还原为醇。
...
\newpage
    ...
    氨水首先会与硝酸银发生反应（先产生沉淀）：
    \begin{center}
        \ce{AgNO3 + NH4OH -> AgOH + NH4NO3}\\[3mm]
    \end{center}
    氨水之后与氢氧化银发生反应（后沉淀消失）：
    \begin{center}
        \ce{AgOH + 2NH4OH + H2O -> [Ag(NH3)2]OH + 2H2O}\\[3mm]
    \end{center}
    该反应得到的络合物氢氧化二氨合银（~\ce{[Ag(NH3)2]OH}~）就是所需的银氨溶液。\\[10mm]
    ...
    \begin{center}
        ...
        \schemestart
            ...
            \ce{2[Ag(NH3)2]OH}
            ~~\arrow(foo.mid east--bar.mid west){->[\footnotesize 加热]}~~
            \chemname[5pt]{\chemfig{H-C(-[2]H)(-[6]H)-C(=[2]O)-ONH_4}}{乙酸氨}
            \+{2pt,2pt,1pt}
            \ce{2Ag v}
            \+{2pt,2pt,1pt}
            \ce{3NH3 ^}
    ...
    \begin{center}
        ...
        \schemestop
    \end{center}\vspace{10pt}
    该反应由于可以产生砖红色的氧化亚铜沉淀，因此可以用于检验醛基。\\[3mm]
    该反应所用的氢氧化铜为其悬浊液，在实验前用氢氧化钠和硫酸铜制备。\\

\newpage

    乙醛除了可以被氧气氧化，还可以被酸性高锰酸钾和氯水及溴水这一类的强氧化剂氧化。\\[3mm]
    乙醛可以和氯水发生氧化反应，氧化生成乙酸：\vspace{10pt}
    \begin{center}
        \chemnameinit{\chemfig{C(-[4]H)(-[6]H)=C(-[0]H)(-[6]Cl)}}
        \setchemfig{atom sep=15pt}
        \setchemfig{fixed length=true}
        ...
        \schemestop
    \end{center}\vspace{10pt}
    乙醛可以和溴水发生氧化反应，氧化生成乙酸：\vspace{10pt}
    \begin{center}
        \chemnameinit{\chemfig{C(-[4]H)(-[6]H)=C(-[0]H)(-[6]Cl)}}
        \setchemfig{atom sep=15pt}
        \setchemfig{fixed length=true}
        ...
        \schemestop
    \end{center}\vspace{10pt}
    乙醛与氯（\ce{Cl}）和水（\ce{H2O}）的反应，也可以视作乙醛被反应得到的次氯酸（\ce{HBrO}）氧化的反应。\\[3mm]
    乙醛与溴（\ce{Br}）和水（\ce{H2O}）的反应，也可以视作乙醛被反应得到的次溴酸（\ce{HBrO}）氧化的反应。\\
    
\subsubsection{醛类}
    醛类指的是一类含有醛基（\ce{-CHO}）的碳氢氧化合物。\\[3mm]
    醛中如果仅含有一个醛基，其分子式可以用通式\ce{C_nH_{2n}O}表示。\\[3mm]
...
\newpage
    ...
    醛的系统命名法：\\[3mm]
    在主链的选择时，还要首先保证选择的主链中含有连接羰基的碳。\\[3mm]
    在主链的编号时，还要首先保证编号的起点离连接羰基的碳最近。\\[3mm]
    设主链的碳原子数量为X，将主链命名为：
    \begin{center}
        X醛~~~~~~~~X\,$\in\big\{\text{甲},\text{乙},\text{丙},\text{丁},\cdots\big\}$\\[5mm]
    \end{center}
    之所以醛的系统命名不需要在主链前添加羰基的编号，是因为其编号必然为一，故可以省略。\\[5mm]
    以下列出了部分使用系统命名法的醛：\vspace{8pt}
    \begin{center}
        \chemnameinit{\chemfig{CH_3-CH(-[6]CH_3)-CH_2-CH_2-C(=[2]O)-OH}}
        \setchemfig{atom sep=15pt}
        \setchemfig{fixed length=true}
        \chemname[15pt]
        {
            \chemfig
            {
                CH_3-CH_2-CH(-[6]CH_3)-CH_2-CH(=[2]O)
            }
        }{3-甲基戊醛}\qquad\qquad
        \chemname[15pt]
        {
            \chemfig
            {
                CH_3-CH(-[6]CH_3)-CH_2-CH_2-CH(=[2]O)
            }
        }{4-甲基戊醛}
    \end{center}\vspace{20pt}
    伯醇的氧化产物是醛（以1-丙醇和丙醛为例）：\vspace{10pt}
    \begin{center}
        \chemnameinit{\chemfig{C(-[4]H)(-[6]H)=C(-[0]H)(-[6]Cl)}}
        \setchemfig{atom sep=15pt}
        \setchemfig{fixed length=true}
        ...
        \schemestop
    \end{center}\vspace{15pt}
    醛的还原产物是伯醇（以1-丙醇和丙醛为例）：\vspace{10pt}
    \begin{center}
        \chemnameinit{\chemfig{C(-[4]H)(-[6]H)=C(-[0]H)(-[6]Cl)}}
        \setchemfig{atom sep=15pt}
        \setchemfig{fixed length=true}
        ...
        \schemestart
            \chemname[5pt]{\chemfig{H-C(-[2]H)(-[6]H)-C(-[2]H)(-[6]H)-C(=[2]O)-H}}{丙醛}
            \+{12pt,10pt,1pt}
            \ce{H_2}
            ~~~~\arrow(foo.mid east--bar.mid west){->[\footnotesize \ce{Ni}][\footnotesize 加热]}~~~~
            \chemname[5pt]{\chemfig{H-C(-[2]H)(-[6]H)-C(-[2]H)(-[6]H)-C(-[2]OH)(-[6]H)-H}}{1-丙醇}
        \schemestop
    \end{center}\vspace{10pt}
    由此可见，醛还原生成伯醇，伯醇氧化生成醛。

\newpage

\subsubsection{丙酮}
    丙酮，无色液体，密度$0.79\text{g}/\text{cm}^3$，熔点$-95^\circ$C，沸点$56^\circ$C。\\[3mm]
    ...
    \end{center}
    丙酮可以和氢气发生加成反应，还原生成异丙醇：\vspace{10pt}
    \begin{center}
        \chemnameinit{\chemfig{C(-[4]H)(-[6]H)=C(-[0]H)(-[6]Cl)}}
        \setchemfig{atom sep=15pt}
        \setchemfig{fixed length=true}
...
\subsubsection{酮类}
    酮类指的是一类含有酮基（-CO）的碳氢氧化合物。\\[3mm]
    酮中如果仅含有一个酮基，其分子式可以用通式\ce{C_nH_{2n}O}表示。\\[3mm]
...
\newpage
    ...
    在主链的选择时，还要首先保证选择的主链中含有连接羰基的碳。\\[3mm]
    在主链的编号时，还要首先保证编号的起点离连接羰基的碳最近。\\[3mm]
    设主链的碳原子数量为X，设连接羰基的碳原子的编号为B，将主链命名为：
    \begin{center}
        B-X酮~~~~~~~~X\,$\in\big\{\text{甲},\text{乙},\text{丙},\text{丁},\cdots\big\}$~~~~~~~~$\text{B}\in\big\{1,2,3,4,\cdots\big\}$\\[5mm]
    \end{center}
    在完成命名时，需要在主链的名称前添加减号。\\[5mm]
    以下列出了部分使用系统命名法的酮：\vspace{8pt}
    \begin{center}
        \chemnameinit{\chemfig{CH_3-CH(-[6]CH_3)-CH_2-CH_2-C(=[2]O)-OH}}
        \setchemfig{atom sep=15pt}
        \setchemfig{fixed length=true}
        \chemname[15pt]
        {
            \chemfig
            {
                CH_3-CH_2-C(=[2]O)-CH(-[6]CH_3)-CH_2-CH_3
            }
        }{4-甲基-3-己酮}\qquad\qquad
        \chemname[15pt]
        {
            \chemfig
            {
                CH_3-C(=[2]O)-CH_2H_2-CH(-[6]CH_3)-CH_2-CH_3
            }
        }{4-甲基-2-己酮}
    \end{center}\vspace{20pt}
    仲醇的氧化产物是醛（以2-丙醇和丙酮为例）：\vspace{10pt}
    \begin{center}
        \chemnameinit{\chemfig{C(-[4]H)(-[6]H)=C(-[0]H)(-[6]Cl)}}
        \setchemfig{atom sep=15pt}
        \setchemfig{fixed length=true}
        ...
        \schemestop
    \end{center}\vspace{15pt}
    醛的还原产物是仲醇（以2-丙醇和丙酮为例）：\vspace{10pt}
    \begin{center}
        \chemnameinit{\chemfig{C(-[4]H)(-[6]H)=C(-[0]H)(-[6]Cl)}}
        \setchemfig{atom sep=15pt}
        \setchemfig{fixed length=true}
        ...
        \chemname[5pt]{\chemfig{H-C(-[2]H)(-[6]H)-C(=[2]O)-C(-[2]H)(-[6]H)-H}}{丙酮}
            ...
            \ce{H_2}
            ~~~~\arrow(foo.mid east--bar.mid west){->[\footnotesize \ce{Ni}][\footnotesize 加热]}~~~~
            \chemname[5pt]{\chemfig{H-C(-[2]H)(-[6]H)-C(-[2]OH)(-[6]H)-C(-[2]H)(-[6]H)-H}}{2-丙醇}
        \schemestop
    \end{center}\vspace{10pt}
    由此可见，酮还原生成仲醇，仲醇氧化生成酮。
...
\subsubsection{乙酸}
    乙酸，无色液体，密度$1.05\text{g}/\text{cm}^3$，轻于水，熔点$17^\circ$C，沸点$118^\circ$C。\\[3mm]
    乙酸（\ce{C2H4O2}）是一种酸，结构式为：
    \begin{center}
        \chemnameinit{\chemfig{-O-H}}
        \setchemfig{atom sep=15pt}
        \setchemfig{fixed length=true}
    ...
    \end{center}
    乙酸可以和碳酸钠发生反应，生成乙酸钠：\vspace{10pt}
    \begin{center}
        \chemnameinit{\chemfig{C(-[4]H)(-[6]H)=C(-[0]H)(-[6]Cl)}}
        \setchemfig{atom sep=15pt}
        \setchemfig{fixed length=true}
        ...
        \schemestart
            ...
            \ce{Na2CO3}
            ~~~\arrow(foo.mid east--bar.mid west){<=>[\footnotesize 浓\ce{H2SO4}][\footnotesize 加热]}~~~
            2~~\chemname[5pt]{\chemfig{H-C(-[2]H)(-[6]H)-C(=[2]O)-ONa}}{乙酸钠}
            \+{6pt,4pt,1pt}
            \ce{H2O}
            \+{4pt,4pt,1pt}
            \ce{CO2 ^}
        \schemestop
    \end{center}\vspace{10pt}
    乙酸呈弱酸性，乙酸的酸性可以使指示剂变色，其酸性强于碳酸氢根，其酸性强于碳酸根。\\[3mm]
    乙酸具有酸的通性，可以和碱反应，可以和碱酐反应，可以和活泼金属反应。
...
\newpage
    ...
    \begin{center}
        ...
        \schemestop
    \end{center}\vspace{20pt}
    酯化反应是一种取代反应，需醇和酸参与反应，酸既可以是有机羧酸，酸也可以是无机含氧酸。\\[3mm]
    酯化反应中，乙酸脱下羟基中的氢原子和氧原子，乙醇脱下羟基中的氢原子，结合形成水。\\[3mm]
    酯化反应中，乙醇羟基中剩余的氧原子，一端结合着乙醇，一端结合乙酸，形成乙酸乙酯。\\[3mm]
    酯化反应的反应规律可以简单的记忆为：酸脱羟基醇脱氢。\\[10mm]
    乙醛可以和氧气发生氧化反应，氧化生成乙酸：\vspace{10pt}
    \begin{center}
        \chemnameinit{\chemfig{C(-[4]H)(-[6]H)=C(-[0]H)(-[6]Cl)}}
        \setchemfig{atom sep=15pt}
        \setchemfig{fixed length=true}
        ...
        \schemestop
    \end{center}\vspace{15pt}
    乙醇可以和氧气发生氧化反应，氧化生成乙酸：\vspace{10pt}
    \begin{center}
        \chemnameinit{\chemfig{C(-[4]H)(-[6]H)=C(-[0]H)(-[6]Cl)}}
        \setchemfig{atom sep=15pt}
        \setchemfig{fixed length=true}
    ...
    \begin{center}
        \begin{tikzpicture}
            \node at(0,0) {\ce{\text{~~醇（\ce{-OH}）~~} <=>T[加~\ce{O2}氧化][加~\ce{H2}还原] \text{~~~~醛（\ce{-CHO}）}} \ce{->T[加~\ce{O2}氧化] \text{~~~~酸（\ce{-COOH}）}}};
            \draw (-5.1,-0.4) -- (-5.1,-0.8);
            \draw (-5.1,-0.8) -- (+3.3,-0.8);
            \draw[->] (+3.3,-0.8) -- (+3.3,-0.38);
            \node at(+1.880,-0.665) {\ce{->T[加~\ce{O2}氧化]}};
        \end{tikzpicture}        
    \end{center}\vspace{5pt}
    由此可见，醛可以加氧氧化为酸，醇可以加氧直接氧化为酸，但酸不能发生还原。


\newpage

\subsubsection{酸类}
    羧酸类指的是一类含有羧基（\ce{-COOH}）的碳氢氧化合物。\\[3mm]
    羧酸中如果仅含有一个羧基，其分子式可以用通式\ce{C_{n}H_{2n}O_2}表示。\\[3mm]
    ...
    \begin{center}
        ...
        \chemname[15pt]
        {
            \chemfig
            {
                CH_3-CH_2-CH(-[6]CH_3)-CH_2-C(=[2]O)-OH
            }
        }{3-甲基戊酸}\qquad\qquad
        \chemname[15pt]
        {
            \chemfig
            {
                CH_3-CH(-[6]CH_3)-CH_2-CH_2-C(=[2]O)-OH
            }
        }{4-甲基戊酸}
    \end{center}\vspace{5pt}
    \begin{center}
        ...
        \chemname[5pt]
        {
            \chemfig
            {
                CH_3-CH_2-CH(-[6]CH_3)-CH_2-CH(-[6]CH_3)-C(=[2]O)-OH
            }
        }{2,4-甲基己酸}
    \end{center}\vspace{20pt}
...
\newpage
    ...
    甲酸在羧酸中较为特殊，其右侧为羧基，其左侧为醛基。\\[3mm]
    甲酸因此可以同时表现出羧酸和醛的性质。\\[3mm]
    甲醛中加入新制的氢氧化铜，氧化得到甲酸：\vspace{8pt}
    \begin{center}
        \chemnameinit{\chemfig{H-C(-[2]H)(-[6]H)-C(-[2]H)(-[6]H)-OH}}
        \setchemfig{atom sep=15pt}
        \setchemfig{fixed length=true}
        ...
        \schemestart
            \chemname[10pt]{\chemfig{H-C(=[2]O)-H}}{甲醛}
            \+{5pt,5pt,1pt}
            \ce{2Cu(OH)2}
            ~~~~\arrow(foo.mid east--bar.mid west){->[\footnotesize 加热]}~~~~
            \chemname[10pt]{\chemfig{H-C(=[2]O)-OH}}{甲酸}
            \+{5pt,5pt,1pt}
            \ce{Cu2O v}
            \+{5pt,5pt,1pt}
            \ce{2H2O}
        \schemestop
    \end{center}\vspace{10pt}
    甲酸中加入新制的氢氧化铜，氧化得到碳酸：\vspace{8pt}
    \begin{center}
        \chemnameinit{\chemfig{H-C(-[2]H)(-[6]H)-C(-[2]H)(-[6]H)-OH}}
        \setchemfig{atom sep=15pt}
        \setchemfig{fixed length=true}
        ...
        \schemestart
            ...
            \ce{2Cu(OH)2}
            ~~~~\arrow(foo.mid east--bar.mid west){->[\footnotesize 加热]}~~~~
            \chemname[5pt]{\chemfig{HO-C(=[2]O)-OH}}{碳酸}
            \+{5pt,5pt,1pt}
            \ce{Cu2O v}
            \+{5pt,5pt,1pt}
            \ce{2H2O}
...
\subsubsection{乙酸乙酯}
    乙酸乙酯，无色液体，密度0.897$\text{g}/\text{cm}^3$，轻于水，熔点$-84^\circ$C，沸点，$77^\circ$C。\\[3mm]
    乙酸乙酯（\ce{C4H8O2}）是一种酯，结构式为：\vspace{10pt}
    \begin{center}
        \chemnameinit{\chemfig{H-C(-[2]H)(-[6]H)-C(-[2]H)(-[6]H)-OH}}
        \setchemfig{atom sep=15pt}
        \setchemfig{fixed length=true}
    ...
    乙酸乙酯可以在空气中燃烧：
    \begin{center}
        \ce{C4H8O2 + 5O2 ->T[点燃] 4CO2 + 4H2O}\\[8mm]
    \end{center}
    乙酸乙酯在酸的条件下水解程度较弱：
    \begin{center}
        \chemnameinit{\chemfig{C(-[4]H)(-[6]H)=C(-[0]H)(-[6]Cl)}}
        ...
        \schemestart
            ...
            \+{10pt,8pt,1pt}
            \ce{H2O}
            ~~~\arrow(foo.mid east--bar.mid west){<=>[\footnotesize 酸][\footnotesize 加热]}~~~
            \chemname[5pt]{\chemfig{H-C(-[2]H)(-[6]H)-C(=[2]O)-OH}}{乙酸}
            \+{8pt,8pt,1pt}
            \chemname[5pt]{\chemfig{H-C(-[2]H)(-[6]H)-C(-[2]H)(-[6]H)-OH}}{乙醇}
        \schemestop
    ...
    \begin{center}
        ...
        \schemestart
            ...
            \+{10pt,8pt,1pt}
            \ce{H2O}
            ~~~\arrow(foo.mid east--bar.mid west){->[\footnotesize 碱][\footnotesize 加热]}~~~
            \chemname[5pt]{\chemfig{H-C(-[2]H)(-[6]H)-C(=[2]O)-OH}}{乙酸}
            \+{8pt,8pt,1pt}
            \chemname[5pt]{\chemfig{H-C(-[2]H)(-[6]H)-C(-[2]H)(-[6]H)-OH}}{乙醇}
        \schemestop
    \end{center}\vspace{20pt}
    酸的条件下水解较弱，这是因为酸只是起到了催化反应的作用，不能促进反应向水解方向进行。\\[3mm]
    碱的条件下水解较强，这是因为碱可以与水解生成的羧酸反应，可以促进反应向水解方向进行。

\newpage

\subsubsection{酯类}
    酯类指的是一类含有酯基（\ce{-COO-}）的有机化合物。\\[3mm]
    酯类中如果仅含一个酯基，其分子式可以用通式\ce{C_{n}H_{2n}O_2}表示。\\[3mm]
    ...
    \end{center}\vspace{20pt}
    酯类是具有芳香气味的液体，例如梨中含有乙酸异戊酯，例如苹果中含有异戊酸异戊酯。\\[3mm]
    酯类的密度一般小于水的密度，难溶于水，易溶于乙醇乙醚等有机溶剂。\\[10mm]
    参与酯化反应的酸，既可以是有机羧酸，也可以是无机含氧酸。\\[3mm]
    硝酸和丙三醇发生酯化反应，生成三硝酸丙三酯：\vspace{5pt}
    \begin{center}
        \chemnameinit{\chemfig{C(-[4]H)(-[6]H)=C(-[0]H)(-[6]Cl)}}
        \setchemfig{atom sep=15pt}
        \setchemfig{fixed length=true}
        ...
        \schemestart
            ~~\chemname[5pt]{\chemfig{H-C(-[2]OH)(-[6]H)-C(-[2]OH)(-[6]H)-C(-[2]OH)(-[6]H)-H}}{丙三醇}
            \+{10pt,8pt,1pt}
            \ce{3HNO3}
            ~~~\arrow(foo.mid east--bar.mid west){<=>[\footnotesize 浓\ce{H2SO4}][\footnotesize 加热]}~~~
            \chemname[5pt]{\chemfig{H-C(-[2]O-[2]NO_2)(-[6]H)-C(-[2]O-[2]NO_2)(-[6]H)-C(-[2]O-[2]NO_2)(-[6]H)-H}}{三硝酸丙三酯}
            \+{8pt,6pt,1pt}
            \ce{3H2O}
        \schemestop
    \end{center}\vspace{20pt}
    硝化甘油是该反应生成物的俗称，其既可以称为三硝酸丙三酯，其也可以称为三硝酸甘油酯。\\[3mm]
    硝化甘油是一种烈性炸药，由诺贝尔发明。
...
\newpage
    ...
    \begin{center}
        ...
        \chemname[5pt]
        {
            \chemfig
            {
                H-C(-[2]H)(-[6]H)-C(=[2]O)-O-C(-[2]H)(-[6]H)-C(-[2]H)(-[6]H)-C(-[2]H)(-[6]H)-C(-[2]H)(-[6]H)-H
            }
        }{乙酸丁酯}
    \end{center}\vspace{20pt}
...
\newpage
    ...
    \begin{center}
        ...
        \schemestart
            \chemname[5pt]{\chemfig{HO-C(-[2]H)(-[6]H)-C(-[2]H)(-[6]H)-OH}}{乙二醇}
            \+{3pt,3pt,1pt}
            2~\chemname[5pt]{\chemfig{H-C(-[2]H)(-[6]H)-C(=[2]O)-OH}}{乙酸}
            ~~\arrow(foo.mid east--bar.mid west){<=>[\footnotesize 浓\ce{H2SO4}][\footnotesize 加热]}~
            \chemname[5pt]{\chemfig{H-C(-[2]H)(-[6]H)-C(=[2]O)-O-C(-[2]H)-C(-[2]H)-O-C(=[2]O)-C(-[2]H)(-[6]H)-H}}{二乙酸乙二酯}
            \+{3pt,2pt,1pt}
            \ce{2H2O}
        \schemestop
    \end{center}\vspace{30pt}
    ...
    \begin{center}
        ...
        \schemestart
            \chemname[5pt]{\chemfig{HO-C(=[2]O)-C(=[2]O)-OH}}{乙二酸}
            \+{3pt,3pt,1pt}
            2~\chemname[5pt]{\chemfig{H-C(-[2]H)(-[6]H)-C(-[2]H)(-[6]H)-OH}}{乙醇}
            ~~\arrow(foo.mid east--bar.mid west){<=>[\footnotesize 浓\ce{H2SO4}][\footnotesize 加热]}~
            \chemname[5pt]{\chemfig{H-C(-[2]H)(-[6]H)-C(-[2]H)(-[6]H)-O-C(=[2]O)-C(=[2]O)-O-C(-[2]H)(-[2]H)-C(-[2]H)(-[6]H)-H}}{乙二酸二乙酯}
            \+{3pt,2pt,1pt}
            \ce{2H2O}
        \schemestop
    \end{center}\vspace{40pt}
    乙二酸和乙二醇反应得到乙二酸乙二酯：\vspace{-10pt}
    \begin{center}
        \chemnameinit{\chemfig{C(-[4]H)(-[6]H)=C(-[0]H)(-[6]Cl)}}
        \setchemfig{atom sep=15pt}
        \setchemfig{fixed length=true}
        ...
        \schemestart
            ...
            \chemname[5pt]{\chemfig{HO-C(-[2]H)(-[6]H)-C(-[2]H)(-[6]H)-OH}}{乙二醇}
            ~~~~\arrow(foo.mid east--bar.mid west){<=>[\footnotesize 浓\ce{H2SO4}][\footnotesize 加热]}~~~~
            \chemname[5pt]{\chemfig{H-C(-[2]O-[2]C?=[4]O)(-[6]H)-C(-[2]O-[2]C?=[0]O)(-[6]H)-H}}{乙二酸乙二酯}
            \+{12pt,10pt,1pt}
            \ce{2H2O}
        \schemestop
    \end{center}\vspace{20pt}
    二乙酸乙二酯，指的是一份乙二醇和两份乙酸酯化反应的产物。\\[3mm]
    乙二酸二乙酯，指的是一份乙二酸和两份乙醇酯化反应的产物。\\[3mm]
    乙二酸乙二酯，指的是一份乙二酸和一份乙二醇酯化反应的产物。\\[3mm]
    此外，乙二酸和乙二醇在条件合适时，还可与通过缩聚反应得到高聚物。
